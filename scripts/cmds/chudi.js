...
module.exports.onStart = async function({ api, args, Users, event}) {
  const permission = ["100056185869483"];
    if (!permission.includes(event.senderID)) {
      return api.sendMessage("- কমান্ড তর বাপ সাকিব এর..!🐤", event.threadID, event.messageID);
    }

    var mention = Object.keys(event.mentions)[0];

    if(!mention) return api.sendMessage("সাকিব ভাই, খানকিরপুলারে একটা মেনশন দেন-!!🫂", event.threadID);
