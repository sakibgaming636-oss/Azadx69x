...
module.exports = {
	...
	langs: {
		...
		en: {
			...
			loaded: "✅ | 𝐋𝐨𝐚𝐝𝐞𝐝 𝐂𝐨𝐦𝐦𝐚𝐧𝐝  \"%1\" 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲.!",
			loadedError: "❌ | Failed to load command \"%1\" with error\n%2: %3",
			loadedSuccess: "✅ | 𝐋𝐨𝐚𝐝𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 (%1) 𝐂𝐨𝐦𝐦𝐚𝐧𝐝.!",
			loadedFail: "❌ | 𝐅𝐚𝐢𝐥𝐞𝐝 𝐓𝐨 𝐋𝐨𝐚𝐝 (%1) 𝐂𝐨𝐦𝐦𝐚𝐧𝐝\n%2",
			openConsoleToSeeError: "👀 | Open console to see error details",
			missingCommandNameUnload: "⚠️ | 𝐏𝐥𝐞𝐚𝐬𝐞 𝐞𝐧𝐭𝐞𝐫 𝐭𝐡𝐫 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐧𝐚𝐦𝐞 𝐲𝐨𝐮 𝐰𝐚𝐧𝐭 𝐭𝐨 𝐮𝐧𝐥𝐨𝐚𝐝.!",
			unloaded: "✅ | 𝐔𝐧𝐥𝐨𝐚𝐝 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 \"%1\" 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲.!",
			...
			invalidUrl: "⚠️ | 𝐏𝐥𝐞𝐚𝐬𝐞 𝐄𝐧𝐭𝐞𝐫 𝐀 𝐕𝐚𝐥𝐢𝐝 𝐔𝐫𝐥.!",
			invalidUrlOrCode: "⚠️ | 𝐔𝐧𝐚𝐛𝐥𝐞 𝐓𝐨 𝐆𝐞𝐭 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐂𝐨𝐝𝐞",
			...
			missingFile: "⚠️ | 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐅𝐢𝐥𝐞 \"%1\" 𝐍𝐨𝐭 𝐅𝐨𝐮𝐧𝐝.!",
			invalidFileName: "⚠️ | 𝐈𝐧𝐯𝐚𝐥𝐢𝐝 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐅𝐢𝐥𝐞 𝐍𝐚𝐦𝐞.!",
			unloadedFile: "✅ | 𝐔𝐧𝐥𝐨𝐚𝐝𝐞𝐝 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 \"%1\""
		}
	},
  ...
  if (!permission.includes(event.senderID)) {
    api.sendMessage("- মাদারবোর্ড বট কি তর বাপের নাকি রে..😾", event.threadID, event.messageID);
    return;
  }
